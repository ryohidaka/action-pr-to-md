...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.filterDataByDateRange = void 0;
/**
 ...
 */
const filterDataByDateRange = (data, since, until) => {
...
exports.filterDataByDateRange = filterDataByDateRange;
...
const filter_1 = __nccwpck_require__(594);
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { userName, isExcludeOwnerRepos, excludedRepos, states, since, until, repoTemplate, itemTemplate, outputFilePath, } = (0, action_1.getInputParameter)();
        ...
        const filteredPrs = (0, filter_1.filterDataByDateRange)(prs, since, until);
        // Group fetched PRs by repository.
        const groupedPrs = (0, grouping_1.groupPRsByRepository)(filteredPrs);
